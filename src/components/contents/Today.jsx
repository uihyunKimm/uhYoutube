        ...
        <section id='today' className='p-10 max-md:mt-16'>
            <div className='today__inner flex bg--ba mb-[3.125rem] max-lg:flex-col'>
                ...
                <div className='today__text w-3/5 p-[2rem] max-2xl:w-[calc(100%-480px)] max-xl:w-full bg-navback-900'>
                    <span className='today bg-navback-900 py-1 px-12 rounded-2xl uppercase mb-2 inline-block text-navback-font'>today!</span>
                    ...
                    <p className='desc mb-[1rem] text-navback-darkfont line-four max-2xl:line-two max-xl:hidden'>{todayText[0].desc}</p>
                    <div className='info'>
